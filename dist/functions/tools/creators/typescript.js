...
const createFiles = (resourcePath, uiFramework) => {
    if (uiFramework === 'none') {
        ...
        fs_1.default.writeFileSync(`${resourcePath}/resources/client/client.ts`, '// Start coding!');
        fs_1.default.writeFileSync(`${resourcePath}/resources/server/server.ts`, '// Start coding!');
    }
};
